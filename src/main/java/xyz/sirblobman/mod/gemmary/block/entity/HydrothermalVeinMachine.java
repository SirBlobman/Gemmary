...
public final class HydrothermalVeinMachine extends AbstractMachine {
    public HydrothermalVeinMachine(BlockPos blockPos, BlockState state) {
        super(GemmaryBlockEntities.HYDROTHERMAL_VEIN.get(), blockPos, state);
    }
