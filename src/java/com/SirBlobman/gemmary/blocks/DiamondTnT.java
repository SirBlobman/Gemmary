...
public class DiamondTnT extends Block
{
    ...
    public DiamondTnT(String unlocalizedName)
    {
        super(Material.tnt);
    ...
    public void explode(World worldIn, BlockPos pos, IBlockState state, EntityLivingBase igniter)
    {
        if (!worldIn.isRemote)
        {
            ...
            {
            	worldIn.newExplosion((Entity)null, (double)pos.getX() + 0.5D, (double)pos.getY() + 0.5D, (double)pos.getZ() + 0.5D, 50.0F, true, true);
            }
        }
    }
