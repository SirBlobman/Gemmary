...
public class CompressorRecipe extends GemmaryRecipeWrapper
{
	@Nonnull
	...
	public CompressorRecipe(@Nonnull List<ItemStack> input, @Nonnull ItemStack output, float experience)
	{
	...
	public void drawInfo(@Nonnull Minecraft minecraft, int recipeWidth, int recipeHeight)
	{
		if(experienceString != null)
		{
			...
			fontRendererObj.drawString(experienceString,  34 - fontRendererObj.getStringWidth(experienceString) / 2, 32, Color.gray.getRGB());
		}
	}
}
